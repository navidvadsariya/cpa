...
#define SDDS_LINUX  // Comment this to run on windows, uncommnet on linux
...
void dateTester() {
   ...
   cin >> D1;
   cout << D1 << endl;
   cout << "Enter " << col_pink << "2019/11/11: " << col_end;
   cin >> D1;
   dateOperatorTester(D2, D1);
   cout << "Enter " << col_pink << "2019/12/11: " << col_end;
   cin >> D1;
   dateOperatorTester(D2, D1);
   cout << "Enter " << col_pink << "2019/10/11: " << col_end;
   cin >> D1;
   dateOperatorTester(D2, D1);
}
